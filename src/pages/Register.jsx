...
const [formData, setFormData] = useState({
  ...
  useEffect(() => {
    const unsubscribe = auth.onAuthStateChanged((currentUser) => {
      if (!currentUser) {
        toast.warn("⚠️ Please login first to register for an event");
        navigate("/login");
      } else {
        setUser(currentUser);
      }
  ...
  return (
    <div className="p-13">
      ...
      <div className="container mx-auto mt-20 p-10">
        <h1 className="text-4xl font-semibold text-pink-500 text-center mb-10">
        ...
        {user && (
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <label className="block text-lg font-bold mb-2" htmlFor="startDate">Start Date:</label>
              <input
              ...
              <div className="mb-6">
                <label className="block text-lg font-bold mb-2" htmlFor="endDate">End Date:</label>
                <input
                  className="w-full p-2 border border-gray-400 rounded"
                  type="date"
                  id="endDate"
